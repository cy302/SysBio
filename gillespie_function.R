...
gillespie <- function(x1, x2, iteration, beta1, beta2, lamda1, lamda2, check_interval){
...
test_result <- gillespie(10,100,1e6, 10,10,100,1000,10000)

tail(test_result$result,100)
